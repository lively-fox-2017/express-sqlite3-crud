...
app.get('/addresses',  (req, res) =>{
  db.all('SELECT * FROM addresses', (err,rows)=> {
    res.render('addresses' , { dataRows:rows} )
  })
})

app.post('/addresses',  (req,res)=> {
  db.all(`insert into addresses values( null , '${req.body.street}' , '${req.body.city}' , '${req.body.zipcode}'  )` , function(err){
    if(err){
      console.log(err);
    } else{
...
app.post('/profiles',  (req,res)=> {
  db.all(`insert into profiles values( null , '${req.body.username}' , '${req.body.password}' )` , function(err){
    if(err){
      console.log(err);
    } else{
